...
const VolatilityFilters: React.FC<VolatilityFiltersProps> = ({ idea, onChangeRange }) => {
  ...
  return (
    <section className="border border-slate-800 rounded-lg bg-slate-900/40">
      ...
      >
        <span className="font-semibold text-slate-200">Volatility Filters</span>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  onChange={(e) => onChangeRange('atrPercent', 'min', e.target.value)}
                />
                <input
                  type="number"
                  className="w-20 bg-slate-900 border border-slate-700 rounded px-2 py-1"
                  ...
                  onChange={(e) => onChangeRange('atrPercent', 'max', e.target.value)}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  onChange={(e) => onChangeRange('hvPercent', 'min', e.target.value)}
                />
                <input
                  type="number"
                  className="w-20 bg-slate-900 border border-slate-700 rounded px-2 py-1"
                  ...
                  onChange={(e) => onChangeRange('hvPercent', 'max', e.target.value)}
                />
              </div>
            </div>
